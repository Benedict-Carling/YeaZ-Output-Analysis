...
print(celldf.groupby("site").mean())
...
print("mean new cell growth fov1&2: ", growth1_2.mean())
print("mean new cell growth fov3&4: ", growth3_4.mean())
print("mean new cell growth fov5&6: ", growth5_6.mean())
print("mean new cell growth fov7&8: ", growth7_8.mean())
