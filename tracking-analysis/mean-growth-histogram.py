...
print("mean new cell growth fov1&2: ", round(growth1_2.mean(),3), " with standard error: ", round(stats.sem(growth1_2),3))
print("mean new cell growth fov3&4: ", round(growth3_4.mean(),3), " with standard error: ", round(stats.sem(growth3_4),3))
print("mean new cell growth fov5&6: ", round(growth5_6.mean(),3), " with standard error: ", round(stats.sem(growth5_6),3))
print("mean new cell growth fov7&8: ", round(growth7_8.mean(),3), " with standard error: ", round(stats.sem(growth7_8),3))
